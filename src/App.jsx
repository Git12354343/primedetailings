    ...
    <>
      ...
      <PageTransition>
        <Routes location={location} key={location.key}>
          ...
          <Route path="/fleet"         element={<PublicLayout><FleetQuote /></PublicLayout>} />
          <Route path="/b2b"           element={<Navigate to="/fleet" replace />} />
  ...
  <div className="min-h-screen flex items-center justify-center px-4" style={{ background: '#0a0a0a' }}>
    <div className="text-center max-w-md">
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center mb-8">
        <a href="/" className="btn-luxury px-6 py-3 rounded-xl text-sm font-bold tracking-wide inline-flex items-center justify-center gap-2">Go Home</a>
        <a href="/booking" className="btn-ghost-luxury px-6 py-3 rounded-xl text-sm font-semibold inline-flex items-center justify-center">Book Now</a>
      </div>
      <div className="grid grid-cols-2 gap-2 rounded-2xl p-4"
        style={{ background:'rgba(255,255,255,0.03)', border:'1px solid rgba(255,255,255,0.07)' }}>
        {[
          { label:'Services',      href:'/services' },
          { label:'Ceramic',       href:'/ceramic-coating' },
          { label:'Fleet/B2B',     href:'/fleet' },
