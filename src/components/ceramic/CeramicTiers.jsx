...
const TierCard = ({ svc, featured, i, visible }) => {
  ...
  return (
    <div className="relative rounded-2xl p-6 flex flex-col"
      style={{
        background: featured ? 'rgba(0,168,204,0.06)' : 'rgba(255,255,255,0.03)',
        border: featured ? '2px solid rgba(0,168,204,0.5)' : '1px solid rgba(255,255,255,0.08)',
        boxShadow: featured ? '0 0 40px rgba(0,168,204,0.15)' : 'none',
      ...
      <div className="mb-5">
        ...
        <div className="text-3xl font-black" style={{ background: 'linear-gradient(135deg,#00a8cc,#00d4ff)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-14" style={{ transition: 'opacity .6s, transform .6s', opacity: visible ? 1 : 0, transform: visible ? 'none' : 'translateY(14px)' }}>
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full mb-4"
            ...
            <span className="text-cyan-400 text-xs font-semibold tracking-widest uppercase">Coating Packages</span>
          </div>
          <h2 className="text-4xl sm:text-5xl font-black text-white mb-3">
            Choose your{' '}
            <span style={{ background: 'linear-gradient(135deg,#00a8cc,#00d4ff)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>protection</span>
          </h2>
        ...
        <div className="rounded-2xl overflow-hidden" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.07)', transition: 'opacity .6s .2s', opacity: visible ? 1 : 0 }}>
          <div className="grid grid-cols-4 px-5 py-4" style={{ borderBottom: '1px solid rgba(255,255,255,0.07)' }}>
            ...
            <div className="text-center text-sm font-bold" style={{ color: '#00d4ff' }}>Ceramic</div>
          </div>
          {COMPARE.map((row, i) => (
            <div key={row.label} className="grid grid-cols-4 px-5 py-3.5 items-center"
              ...
              <div className="text-center text-sm font-semibold flex items-center justify-center gap-1" style={{ color: '#00d4ff' }}>
