...
const DashboardHeader = ({ detailer, todaysEarnings, onLogout, onNavigateHome }) => {
  ...
  return (
    <header className="sticky top-0 z-40"
      style={{ background: 'rgba(10,10,10,0.95)', borderBottom: '1px solid rgba(201,168,76,0.15)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)' }}>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold"
                style={{ background: 'rgba(201,168,76,0.15)', color: GOLD_S, border: '1px solid rgba(201,168,76,0.25)' }}>
                {initials}
              </div>
