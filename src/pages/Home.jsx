      ...
      {[
        {
          ...
          desc:  'Home, condo, parking lot, office, or street. No shop visit required.',
        },
        {
          icon: CreditCard,
          color: '#34d399',
          title: 'No payment to book',
          desc:  'Choose your service and confirm your appointment. Pay only after.',
        },
        {
          icon: ShieldCheck,
          color: '#a78bfa',
          title: 'Satisfaction guaranteed',
          desc:  "We review the results with you before payment. If it's not right, we fix it.",
        },
