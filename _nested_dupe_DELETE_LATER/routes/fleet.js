        ...
        <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#0b0f1a;color:#fff;border-radius:12px;overflow:hidden;">
          ...
          <div style="padding:28px;">
            <table style="width:100%;border-collapse:collapse;">
              ...
              <tr><td style="padding:6px 0;color:rgba(255,255,255,0.5);font-size:13px;">Email</td><td><a href="mailto:${quote.email}" style="color:#00a8cc;">${quote.email}</a></td></tr>
              <tr><td style="padding:6px 0;color:rgba(255,255,255,0.5);font-size:13px;">Phone</td><td><a href="tel:${quote.phone}" style="color:#00a8cc;">${quote.phone}</a></td></tr>
